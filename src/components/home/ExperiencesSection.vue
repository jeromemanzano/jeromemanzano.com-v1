  ...
  <section>
    ...
    <ol class="transition-group vertical flex flex-col gap-4 text-secondaryTextColor max-w-3xl mx-auto">
      <li
        ...
        class="group border-[1px] border-borderColor pb-6 px-8 transition from:translate-x-5 from:opacity-0 duration-500 overflow-hidden fill-hover"
      >
        <div class="w-full flex py-5 items-center">
          <span class="bg-borderColor group-[:hover:not(.active)]:bg-contentTextColor w-[50px] h-1 mr-4"></span>
        ...
        <h3
          class="block text-sm md:text-xl font-semibold group-[:hover:not(.active)]:text-contentTextColor group-[.active]:text-textColor"
        >
          {{ experience.positions[0].title }}
          <a
            :href="experience.company.website"
            class="uppercase text-textColor group-[:hover:not(.active)]:text-contentTextColor font-semibold group-[.active]:text-textActiveColor"
        ...
        <div class="details hidden font-roboto group-[.active]:block">
          ...
          <ul class="flex flex-wrap gap-x-5 text-textColor">
            <li
